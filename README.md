...
The smart floor heating controller has three principal modes of operation, automatic, summer and manual. Choose the mode of operation from the front-end or through automations in Home Assistant.
