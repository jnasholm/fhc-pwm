...
The controller enters summer mode when the outdoor temperature is above the configured level. This mode will maintain circulation in all zones regardless of current temperature in each zone.
