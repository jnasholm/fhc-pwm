...
<br>
*Prototype installed in connection cabinet. Floor heating controller on the left and [mixing valve controller](https://github.com/jnasholm/mvc-pwm) on the right.*
